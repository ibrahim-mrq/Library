...
public class FastScroller extends LinearLayout {
    ...
    public FastScroller(Context context, AttributeSet attrs, int defStyle) {
        ...
        try {
            textColor = style.getColor(R.styleable.fastscroll__fastScroller_fastscroll__textColor, STYLE_NONE);
    ...
    /**
     * Set the text color of the bubble.
     *
    ...
    private void applyStyling() {
        if (textColor != STYLE_NONE) setTextColor(textColor);
